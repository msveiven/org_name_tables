...
if len(sys.argv) != 3:
    ...
    print('If you want to update a single directory with links, first delete the index.htm file that you want to update and then write this: "python $WIKIPROTPATH/websiteCreatory.py update_directory your_url"')
